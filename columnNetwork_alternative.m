...
% a single PV in each of the 2 layers ('2layer'); the single PV neuron then 
% inhibits both the onset- and offset- excitatory cell in the same layer
