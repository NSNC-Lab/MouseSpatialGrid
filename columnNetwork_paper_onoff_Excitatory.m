function [simdata,s] = columnNetwork_paper_onoff_Excitatory(study_dir,varies,options,netcons,flag_raised_mex)
...
%This network was set up in response to the reviewers for the modeling
%paper. In this particular example ROff was taken out and the offset and
%onset parmeters that flow into the excitatory cells were combined.
...
s.connections(end).mechanism_list={'PSC'};
s.connections(end).parameters={'gSYN',0.005,'tauR',EI_rise,'tauD',EI_fall,'fP',0,'tauP',80};
