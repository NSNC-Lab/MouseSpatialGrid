...
ROn_SOnOff_PSC_netcon = ROn_SOnOff_PSC_netcon;
ROn_SOnOff_PSC_scale = (ROn_SOnOff_PSC_tauD/ROn_SOnOff_PSC_tauR)^(ROn_SOnOff_PSC_tauR/(ROn_SOnOff_PSC_tauD-ROn_SOnOff_PSC_tauR));
...
ROn_SOnOff_PSC_s = zeros(2,SOnOff_Npop);
ROn_SOnOff_PSC_s(1,:) =  zeros(1,SOnOff_Npop);
ROn_SOnOff_PSC_x = zeros(2,SOnOff_Npop);
ROn_SOnOff_PSC_x(1,:) =  zeros(1,SOnOff_Npop);
ROn_SOnOff_PSC_F = zeros(2,SOnOff_Npop);
ROn_SOnOff_PSC_F(1,:) =  ones(1,SOnOff_Npop);
ROn_SOnOff_PSC_P = zeros(2,SOnOff_Npop);
ROn_SOnOff_PSC_P(1,:) =  ones(1,SOnOff_Npop);
ROn_SOnOff_PSC_q = zeros(2,SOnOff_Npop);
ROn_SOnOff_PSC_q(1,:) =  ones(1,SOnOff_Npop);
...
ROn_SOnOff_PSC_syn = zeros(nsamp,ROn_Npop);
ROn_SOnOff_PSC_syn(1,:)=ROn_SOnOff_PSC_gSYN.*(ROn_SOnOff_PSC_s(1,:)*ROn_SOnOff_PSC_netcon).*(ROn_V(1,:)-ROn_SOnOff_PSC_ESYN);
...
for k=2:ntime
  ...
  ROn_V_k1 = ( (ROn_E_L-ROn_V(1,:)) - ROn_R*ROn_g_ad(1,:).*(ROn_V(1,:)-ROn_E_k) - ROn_R*((((((ROn_On_PSC3_s(1,:)*(ROn_On_PSC3_netcon.*ROn_On_PSC3_gSYN)).*(ROn_V(1,:)-ROn_On_PSC3_ESYN)))))+((((ROn_SOnOff_PSC_gSYN.*(ROn_SOnOff_PSC_s(1,:)*ROn_SOnOff_PSC_netcon).*(ROn_V(1,:)-ROn_SOnOff_PSC_ESYN))))+((((ROn_ROn_iNoise_V3_nSYN.*(ROn_ROn_iNoise_V3_sn(1,:)*ROn_ROn_iNoise_V3_netcon).*(ROn_V(1,:)-ROn_ROn_iNoise_V3_E_exc))))+((((((ROn_X_PSC3_s(1,:)*(ROn_X_PSC3_netcon.*ROn_X_PSC3_gSYN)).*(ROn_V(1,:)-ROn_X_PSC3_ESYN)))))+((((ROn_TD_PSC_gSYN.*(ROn_TD_PSC_s(1,:)*ROn_TD_PSC_netcon).*(ROn_V(1,:)-ROn_TD_PSC_ESYN))))))))) + ROn_R*ROn_Itonic.*ROn_Imask + ROn_R*ROn_noise.*randn(1,ROn_Npop) ) / ROn_tau;
  ...
  ROn_SOnOff_PSC_s_k1 = ( ROn_SOnOff_PSC_scale * ROn_SOnOff_PSC_x(1,:) - ROn_SOnOff_PSC_s(1,:) )/ROn_SOnOff_PSC_tauR;
  ROn_SOnOff_PSC_x_k1 = -ROn_SOnOff_PSC_x(1,:)/ROn_SOnOff_PSC_tauD;
  ROn_SOnOff_PSC_F_k1 = (1 - ROn_SOnOff_PSC_F(1,:))/ROn_SOnOff_PSC_tauF;
  ROn_SOnOff_PSC_P_k1 = (1 - ROn_SOnOff_PSC_P(1,:))/ROn_SOnOff_PSC_tauP;
  ...
  conditional_test=any(any(t == SOnOff_tspike+ROn_SOnOff_PSC_delay,1));
  conditional_indx=(any(t == SOnOff_tspike+ROn_SOnOff_PSC_delay,1));
  if conditional_test, ROn_SOnOff_PSC_x(2,conditional_indx) = ROn_SOnOff_PSC_x(2,conditional_indx) + ROn_SOnOff_PSC_q(2,conditional_indx);ROn_SOnOff_PSC_q(2,conditional_indx) = ROn_SOnOff_PSC_F(2,conditional_indx).*ROn_SOnOff_PSC_P(2,conditional_indx);ROn_SOnOff_PSC_F(2,conditional_indx) = ROn_SOnOff_PSC_F(2,conditional_indx) + ROn_SOnOff_PSC_fF*(ROn_SOnOff_PSC_maxF-ROn_SOnOff_PSC_F(2,conditional_indx)); ROn_SOnOff_PSC_P(2,conditional_indx) = ROn_SOnOff_PSC_P(2,conditional_indx)*(1 - ROn_SOnOff_PSC_fP); end
  ...
  ROn_SOnOff_PSC_syn(n,:)=ROn_SOnOff_PSC_gSYN.*(ROn_SOnOff_PSC_s(2,:)*ROn_SOnOff_PSC_netcon).*(ROn_V(2,:)-ROn_SOnOff_PSC_ESYN);
