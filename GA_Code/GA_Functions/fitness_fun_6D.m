...
function fitness = fitness_fun_4D(Target_grid,Target_fr_grid, varied_params, optionsGA, plot_all, toggle_real)
    ...
    varied_struct.XR3 = varied_params(5);
    varied_struct.XR10 = varied_params(6);

    % varied_struct.RtoC1 = 0.00263264665761118;
    % varied_struct.RtoC2 = 0.000647159029394951;
    % varied_struct.RtoC3 = 0.00305504412105594;
    % varied_struct.RtoC4 = 0.00305504412105594;
    % varied_struct.XR3 = 0.00902581703086024;
    % varied_struct.XR10 = 0.0390617957647365;


    %0.00263264665761118	0.000647159029394951	0.00305504412105594	0.00508432969016609	0.00902581703086024	0.0390617957647365
