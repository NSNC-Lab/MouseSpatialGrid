% Fitness function
function fitness = fitness_fun_5D(Target_grid,Target_fr_grid, varied_params, optionsGA, plot_all)
    ...
    %Now that we have 1 som connection we are starting to worry about the
    %performance values in the upper left hand corner. Lets start by
    %weighting it fairly heavy and see if we cannot hit 87 in the upper
    %left with this new implementation.
