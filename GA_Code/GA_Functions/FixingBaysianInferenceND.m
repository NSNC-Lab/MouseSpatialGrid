...
function likelyhood = get_log_likelyhood(X_known,Y_known,kernal_length,kernal_vertical_variation,noise)
    ...
    %FYI if there is only one point left in the space this likelyhood
    %function will not function correctly. This shouldn't ever really be
    %feasible with the correct starting size and mutation rate. But it is
