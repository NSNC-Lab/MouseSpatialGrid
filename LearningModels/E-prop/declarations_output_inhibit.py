def Declare_Architecture(opts):
    ...
    Relay_1 = Lif_Neuron.Build_Vars(name = 'ROn',is_output=1,is_noise=1, g_inc = 0.001, tau_ad = 100,final_grad_node = 1,nSYN=0.015, g_L = 1/100, E_L = -57, V_reset = -52, t_ref = 0.5)
    ...
    On_R1_synapse = Lif_Synapse.Build_Vars(name = 'On_ROn',fP=0.2,gSYN=0.02,tauP=80, tauR=0.1, tauD=1,delay=1)
    ...
    S1_R1_synapse = Lif_Synapse.Build_Vars(name = 'SOnOff_ROn',gSYN=0.025,fP=0.5,tauP=120, tauR=1, tauD=4.5,ESYN=-80, delay=0.5) #PV->PV?
    Off_R1_synapse = Lif_Synapse.Build_Vars(name = 'Off_ROn',fP=0.1,gSYN=0.0,tauP=80, tauR=0.1, tauD=1,delay=1)
