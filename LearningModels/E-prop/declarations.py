def Declare_Architecture(opts):
    ...
    Relay_1 = Lif_Neuron.Build_Vars(name = 'ROn',is_output=1,is_noise=1, g_inc = 0.0003, tau_ad = 100,final_grad_node = 1,nSYN=0.015,C=0.1, t_ref = 4)
    ...
    On_R1_synapse = Lif_Synapse.Build_Vars(name = 'On_ROn',fP=0.1,gSYN=0.015,tauP=30, tauR=0.7, tauD=1.5,delay=1)
    ...
    S1_R1_synapse = Lif_Synapse.Build_Vars(name = 'SOnOff_ROn',gSYN=0.08,fP=0.5,tauP=120, tauR=1, tauD=4.5,ESYN=-80, delay=0.5)
