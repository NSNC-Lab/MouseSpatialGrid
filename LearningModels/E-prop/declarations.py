def Declare_Architecture(opts):
    ...
    Onset_input = Lif_Neuron.Build_Vars(name = 'On',is_input=1, response = 'onset',g_postIC = 0.17, g_inc = 0.0003)
    Offset_input = Lif_Neuron.Build_Vars(name = 'Off',is_input=1, response = 'offset',g_postIC = 0.17, g_inc = 0.0003)
    PV_1 = Lif_Neuron.Build_Vars(name = 'SOnOff', E_L = -57, g_L = 1/100, V_reset = -52, t_ref = 0.5)
    Relay_1 = Lif_Neuron.Build_Vars(name = 'ROn',is_output=1,is_noise=1, g_inc = 0.0003,final_grad_node = 1,nSYN=0.015)
    ...
    On_R1_synapse = Lif_Synapse.Build_Vars(name = 'On_ROn',fP=0.1,gSYN=0.02,tauP=30, tauR=0.7, tauD=1.5,delay=3)
