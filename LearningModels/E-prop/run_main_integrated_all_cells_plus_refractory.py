...
from BuildFile import Forwards_Method_cupy_Refractory, Compile_Solve, calculate_loss_all_cells
import numpy as np
import time
...
class runSimulation(object):
    ...
    file_body_forwards = Forwards_Method_cupy_Refractory.Euler_Compiler(arch[0],arch[1],arch[2],opts,num_cells)
