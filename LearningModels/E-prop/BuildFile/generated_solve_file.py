...
def solve_run(on_input,off_input,noise_token,rate_on,rate_off,rate_on_deriv,rate_off_deriv,data,p):
    ...
    On_ROn_tauR = 0.7
    On_ROn_PSC_delay = 1
    On_ROn_gSYN = p[3].reshape(50, 1, 1)
    On_ROn_PSC_fF = 0
    On_ROn_PSC_fP = 0.1
    On_ROn_tauF = 180
    On_ROn_tauP = 30
    ...
    Off_ROn_tauR = 0.7
    Off_ROn_PSC_delay = 1
    Off_ROn_gSYN = p[4].reshape(50, 1, 1)
    Off_ROn_PSC_fF = 0
    Off_ROn_PSC_fP = 0.1
    Off_ROn_tauF = 180
    Off_ROn_tauP = 30
    ...
    On_SOnOff_gSYN = p[5].reshape(50, 1, 1)
    On_SOnOff_PSC_fF = 0
    ...
    Off_SOnOff_gSYN = p[6].reshape(50, 1, 1)
    Off_SOnOff_PSC_fF = 0
    ...
    SOnOff_ROn_gSYN = p[7].reshape(50, 1, 1)
    SOnOff_ROn_PSC_fF = 0
    ...
    On_V = np.ones((50,10,1,2)) * On_E_L
    On_g_ad = np.zeros((50,10,1,2))
    On_tspike = np.ones((50,10,1,5)) * -30
    On_buffer_index = np.ones((50,10,1))
    spike_wrt_tau_ad_On = np.zeros((50,10,1))
    spike_wrt_g_inc_On = np.zeros((50,10,1))
    Off_V = np.ones((50,10,1,2)) * Off_E_L
    Off_g_ad = np.zeros((50,10,1,2))
    Off_tspike = np.ones((50,10,1,5)) * -30
    Off_buffer_index = np.ones((50,10,1))
    spike_wrt_tau_ad_Off = np.zeros((50,10,1))
    spike_wrt_g_inc_Off = np.zeros((50,10,1))
    SOnOff_V = np.ones((50,10,1,2)) * SOnOff_E_L
    SOnOff_g_ad = np.zeros((50,10,1,2))
    SOnOff_tspike = np.ones((50,10,1,5)) * -30
    SOnOff_buffer_index = np.ones((50,10,1))
    spike_wrt_tau_ad_SOnOff = np.zeros((50,10,1))
    spike_wrt_g_inc_SOnOff = np.zeros((50,10,1))
    ROn_V = np.ones((50,10,1,2)) * ROn_E_L
    ROn_g_ad = np.zeros((50,10,1,2))
    ROn_tspike = np.ones((50,10,1,5)) * -30
    ROn_buffer_index = np.ones((50,10,1))
    ROn_spikes_holder = np.zeros((50,10,1,29801), dtype=np.int8)
    On_SOnOff_PSC_s_holder = np.zeros((50,10,1,29801), dtype=np.int8)
    Off_SOnOff_PSC_s_holder = np.zeros((50,10,1,29801), dtype=np.int8)
    losses_holder = np.zeros((50,1,1,29801), dtype=np.int8)
    ROn_noise_sn = np.zeros((50,10,1,2))
    ROn_noise_xn = np.zeros((50,10,1,2))
    spike_wrt_tau_ad_ROn = np.zeros((50,10,1))
    spike_wrt_g_inc_ROn = np.zeros((50,10,1))
    On_ROn_PSC_s = np.zeros((50,10,1,2))
    On_ROn_PSC_x = np.zeros((50,10,1,2))
    On_ROn_PSC_F = np.ones((50,10,1,2))
    On_ROn_PSC_P = np.ones((50,10,1,2))
    On_ROn_PSC_q = np.ones((50,10,1,2))
    spike_wrt_gsyn_On_ROn_accumulate = np.zeros((50,10,1,loss_bin_width))
    grad_On_ROn = np.zeros((50,10,1))
    Off_ROn_PSC_s = np.zeros((50,10,1,2))
    Off_ROn_PSC_x = np.zeros((50,10,1,2))
    Off_ROn_PSC_F = np.ones((50,10,1,2))
    Off_ROn_PSC_P = np.ones((50,10,1,2))
    Off_ROn_PSC_q = np.ones((50,10,1,2))
    spike_wrt_gsyn_Off_ROn_accumulate = np.zeros((50,10,1,loss_bin_width))
    grad_Off_ROn = np.zeros((50,10,1))
    On_SOnOff_PSC_s = np.zeros((50,10,1,2))
    On_SOnOff_PSC_x = np.zeros((50,10,1,2))
    On_SOnOff_PSC_F = np.ones((50,10,1,2))
    On_SOnOff_PSC_P = np.ones((50,10,1,2))
    On_SOnOff_PSC_q = np.ones((50,10,1,2))
    spike_wrt_gsyn_On_SOnOff_accumulate = np.zeros((50,10,1,loss_bin_width))
    grad_On_SOnOff = np.zeros((50,10,1))
    Off_SOnOff_PSC_s = np.zeros((50,10,1,2))
    Off_SOnOff_PSC_x = np.zeros((50,10,1,2))
    Off_SOnOff_PSC_F = np.ones((50,10,1,2))
    Off_SOnOff_PSC_P = np.ones((50,10,1,2))
    Off_SOnOff_PSC_q = np.ones((50,10,1,2))
    spike_wrt_gsyn_Off_SOnOff_accumulate = np.zeros((50,10,1,loss_bin_width))
    grad_Off_SOnOff = np.zeros((50,10,1))
    SOnOff_ROn_PSC_s = np.zeros((50,10,1,2))
    SOnOff_ROn_PSC_x = np.zeros((50,10,1,2))
    SOnOff_ROn_PSC_F = np.ones((50,10,1,2))
    SOnOff_ROn_PSC_P = np.ones((50,10,1,2))
    SOnOff_ROn_PSC_q = np.ones((50,10,1,2))
    spike_wrt_gsyn_SOnOff_ROn_accumulate = np.zeros((50,10,1,loss_bin_width))
    grad_SOnOff_ROn = np.zeros((50,10,1))
    grad_strf_gain = np.zeros((50,10,1))
    grad_strf_latency = np.zeros((50,10,1))
    grad_output_adaptation = np.zeros((50,10,1))
    ...
    for timestep,t in enumerate(np.arange(0,29801*0.1-0.1,0.1)):
        ...
        psi_On = (1 - np.tanh(On_V[:,:,:,-1] - On_V_thresh)**2)
        psi_Off = (1 - np.tanh(Off_V[:,:,:,-1] - Off_V_thresh)**2)
        ...
        eligibility_strf_gain = ((psi_On * (-On_R) * On_g_postIC * 30 * (1 - np.tanh(0.0001*rate_on[timestep,:][:,None,None]-1.5)**2) * On_netcon * (On_V[:,:,:,-1]-On_E_exc)) / On_tau) + ((psi_Off * (-Off_R) * Off_g_postIC * 30 *(1 - np.tanh(0.0001*rate_off[timestep,:][:,None,None]-1.5)**2) * Off_netcon * (Off_V[:,:,:,-1]-Off_E_exc)) / Off_tau)
        eligibility_strf_latency = ((psi_On * (-On_R) * On_g_postIC * 30 *(1 - np.tanh(0.0001*rate_on_deriv[timestep,:][:,None,None]-1.5)**2) * On_netcon * (On_V[:,:,:,-1]-On_E_exc)) / On_tau) + ((psi_Off * (-Off_R) * Off_g_postIC * 30 *(1 - np.tanh(0.0001*rate_off_deriv[timestep,:][:,None,None]-1.5)**2) * Off_netcon * (Off_V[:,:,:,-1]-Off_E_exc)) / Off_tau)
        eligibility_output_adaptation = (-ROn_R*(((1+np.tanh(ROn_V[:,:,:,-1]-ROn_V_thresh))/2)*((1+np.tanh(-(ROn_V[:,:,:,-2]-ROn_V_thresh)))/2))*0.1*(ROn_V[:,:,:,-1]-ROn_E_k))/ROn_tau
        ...
        if timestep % loss_bin_width == 0 and timestep != 0:
            ...
            grad_output_adaptation_accumulate = 0
    grads = np.sum(np.stack([grad_strf_gain,grad_strf_latency,grad_output_adaptation,grad_On_ROn,grad_Off_ROn,grad_On_SOnOff,grad_Off_SOnOff,grad_SOnOff_ROn], axis = 0), axis = 2)
