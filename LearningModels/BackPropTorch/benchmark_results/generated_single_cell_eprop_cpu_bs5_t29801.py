...
def solve_run(on_input,off_input,noise_token,rate_on,rate_off,rate_on_deriv,rate_off_deriv,data,p):
    ...
    On_V = np.ones((5,10,1,2)) * On_E_L
    On_g_ad = np.zeros((5,10,1,2))
    On_tspike = np.ones((5,10,1,5)) * -30
    On_buffer_index = np.ones((5,10,1))
    spike_wrt_tau_ad_On = np.zeros((5,10,1))
    spike_wrt_g_inc_On = np.zeros((5,10,1))
    Off_V = np.ones((5,10,1,2)) * Off_E_L
    Off_g_ad = np.zeros((5,10,1,2))
    Off_tspike = np.ones((5,10,1,5)) * -30
    Off_buffer_index = np.ones((5,10,1))
    spike_wrt_tau_ad_Off = np.zeros((5,10,1))
    spike_wrt_g_inc_Off = np.zeros((5,10,1))
    SOnOff_V = np.ones((5,10,1,2)) * SOnOff_E_L
    SOnOff_g_ad = np.zeros((5,10,1,2))
    SOnOff_tspike = np.ones((5,10,1,5)) * -30
    SOnOff_buffer_index = np.ones((5,10,1))
    spike_wrt_tau_ad_SOnOff = np.zeros((5,10,1))
    spike_wrt_g_inc_SOnOff = np.zeros((5,10,1))
    ROn_V = np.ones((5,10,1,2)) * ROn_E_L
    ROn_g_ad = np.zeros((5,10,1,2))
    ROn_tspike = np.ones((5,10,1,5)) * -30
    ROn_buffer_index = np.ones((5,10,1))
    ROn_spikes_holder = np.zeros((5,10,1,29801), dtype=np.int8)
    On_SOnOff_PSC_s_holder = np.zeros((5,10,1,29801), dtype=np.int8)
    Off_SOnOff_PSC_s_holder = np.zeros((5,10,1,29801), dtype=np.int8)
    losses_holder = np.zeros((5,1,1,29801), dtype=np.int8)
    ROn_noise_sn = np.zeros((5,10,1,2))
    ROn_noise_xn = np.zeros((5,10,1,2))
    spike_wrt_tau_ad_ROn = np.zeros((5,10,1))
    spike_wrt_g_inc_ROn = np.zeros((5,10,1))
    On_ROn_PSC_s = np.zeros((5,10,1,2))
    On_ROn_PSC_x = np.zeros((5,10,1,2))
    On_ROn_PSC_F = np.ones((5,10,1,2))
    On_ROn_PSC_P = np.ones((5,10,1,2))
    On_ROn_PSC_q = np.ones((5,10,1,2))
    spike_wrt_gsyn_On_ROn_accumulate = np.zeros((5,10,1,loss_bin_width))
    grad_On_ROn = np.zeros((5,10,1))
    Off_ROn_PSC_s = np.zeros((5,10,1,2))
    Off_ROn_PSC_x = np.zeros((5,10,1,2))
    Off_ROn_PSC_F = np.ones((5,10,1,2))
    Off_ROn_PSC_P = np.ones((5,10,1,2))
    Off_ROn_PSC_q = np.ones((5,10,1,2))
    spike_wrt_gsyn_Off_ROn_accumulate = np.zeros((5,10,1,loss_bin_width))
    grad_Off_ROn = np.zeros((5,10,1))
    On_SOnOff_PSC_s = np.zeros((5,10,1,2))
    On_SOnOff_PSC_x = np.zeros((5,10,1,2))
    On_SOnOff_PSC_F = np.ones((5,10,1,2))
    On_SOnOff_PSC_P = np.ones((5,10,1,2))
    On_SOnOff_PSC_q = np.ones((5,10,1,2))
    spike_wrt_gsyn_On_SOnOff_accumulate = np.zeros((5,10,1,loss_bin_width))
    grad_On_SOnOff = np.zeros((5,10,1))
    Off_SOnOff_PSC_s = np.zeros((5,10,1,2))
    Off_SOnOff_PSC_x = np.zeros((5,10,1,2))
    Off_SOnOff_PSC_F = np.ones((5,10,1,2))
    Off_SOnOff_PSC_P = np.ones((5,10,1,2))
    Off_SOnOff_PSC_q = np.ones((5,10,1,2))
    spike_wrt_gsyn_Off_SOnOff_accumulate = np.zeros((5,10,1,loss_bin_width))
    grad_Off_SOnOff = np.zeros((5,10,1))
    SOnOff_ROn_PSC_s = np.zeros((5,10,1,2))
    SOnOff_ROn_PSC_x = np.zeros((5,10,1,2))
    SOnOff_ROn_PSC_F = np.ones((5,10,1,2))
    SOnOff_ROn_PSC_P = np.ones((5,10,1,2))
    SOnOff_ROn_PSC_q = np.ones((5,10,1,2))
    spike_wrt_gsyn_SOnOff_ROn_accumulate = np.zeros((5,10,1,loss_bin_width))
    grad_SOnOff_ROn = np.zeros((5,10,1))
    grad_strf_gain = np.zeros((5,10,1))
    grad_strf_latency = np.zeros((5,10,1))
    grad_output_adaptation = np.zeros((5,10,1))
