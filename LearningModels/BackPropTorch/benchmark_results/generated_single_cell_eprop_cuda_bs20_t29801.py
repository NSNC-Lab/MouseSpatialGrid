...
def solve_run(on_input,off_input,noise_token,rate_on,rate_off,rate_on_deriv,rate_off_deriv,data,p):
    ...
    On_V = cp.ones((20,10,1,2)) * On_E_L
    On_g_ad = cp.zeros((20,10,1,2))
    On_tspike = cp.ones((20,10,1,5)) * -30
    On_buffer_index = cp.ones((20,10,1))
    spike_wrt_tau_ad_On = cp.zeros((20,10,1))
    spike_wrt_g_inc_On = cp.zeros((20,10,1))
    Off_V = cp.ones((20,10,1,2)) * Off_E_L
    Off_g_ad = cp.zeros((20,10,1,2))
    Off_tspike = cp.ones((20,10,1,5)) * -30
    Off_buffer_index = cp.ones((20,10,1))
    spike_wrt_tau_ad_Off = cp.zeros((20,10,1))
    spike_wrt_g_inc_Off = cp.zeros((20,10,1))
    SOnOff_V = cp.ones((20,10,1,2)) * SOnOff_E_L
    SOnOff_g_ad = cp.zeros((20,10,1,2))
    SOnOff_tspike = cp.ones((20,10,1,5)) * -30
    SOnOff_buffer_index = cp.ones((20,10,1))
    spike_wrt_tau_ad_SOnOff = cp.zeros((20,10,1))
    spike_wrt_g_inc_SOnOff = cp.zeros((20,10,1))
    ROn_V = cp.ones((20,10,1,2)) * ROn_E_L
    ROn_g_ad = cp.zeros((20,10,1,2))
    ROn_tspike = cp.ones((20,10,1,5)) * -30
    ROn_buffer_index = cp.ones((20,10,1))
    ROn_spikes_holder = cp.zeros((20,10,1,29801), dtype=cp.int8)
    On_SOnOff_PSC_s_holder = cp.zeros((20,10,1,29801), dtype=cp.int8)
    Off_SOnOff_PSC_s_holder = cp.zeros((20,10,1,29801), dtype=cp.int8)
    losses_holder = cp.zeros((20,1,1,29801), dtype=cp.int8)
    ROn_noise_sn = cp.zeros((20,10,1,2))
    ROn_noise_xn = cp.zeros((20,10,1,2))
    spike_wrt_tau_ad_ROn = cp.zeros((20,10,1))
    spike_wrt_g_inc_ROn = cp.zeros((20,10,1))
    On_ROn_PSC_s = cp.zeros((20,10,1,2))
    On_ROn_PSC_x = cp.zeros((20,10,1,2))
    On_ROn_PSC_F = cp.ones((20,10,1,2))
    On_ROn_PSC_P = cp.ones((20,10,1,2))
    On_ROn_PSC_q = cp.ones((20,10,1,2))
    spike_wrt_gsyn_On_ROn_accumulate = cp.zeros((20,10,1,loss_bin_width))
    grad_On_ROn = cp.zeros((20,10,1))
    Off_ROn_PSC_s = cp.zeros((20,10,1,2))
    Off_ROn_PSC_x = cp.zeros((20,10,1,2))
    Off_ROn_PSC_F = cp.ones((20,10,1,2))
    Off_ROn_PSC_P = cp.ones((20,10,1,2))
    Off_ROn_PSC_q = cp.ones((20,10,1,2))
    spike_wrt_gsyn_Off_ROn_accumulate = cp.zeros((20,10,1,loss_bin_width))
    grad_Off_ROn = cp.zeros((20,10,1))
    On_SOnOff_PSC_s = cp.zeros((20,10,1,2))
    On_SOnOff_PSC_x = cp.zeros((20,10,1,2))
    On_SOnOff_PSC_F = cp.ones((20,10,1,2))
    On_SOnOff_PSC_P = cp.ones((20,10,1,2))
    On_SOnOff_PSC_q = cp.ones((20,10,1,2))
    spike_wrt_gsyn_On_SOnOff_accumulate = cp.zeros((20,10,1,loss_bin_width))
    grad_On_SOnOff = cp.zeros((20,10,1))
    Off_SOnOff_PSC_s = cp.zeros((20,10,1,2))
    Off_SOnOff_PSC_x = cp.zeros((20,10,1,2))
    Off_SOnOff_PSC_F = cp.ones((20,10,1,2))
    Off_SOnOff_PSC_P = cp.ones((20,10,1,2))
    Off_SOnOff_PSC_q = cp.ones((20,10,1,2))
    spike_wrt_gsyn_Off_SOnOff_accumulate = cp.zeros((20,10,1,loss_bin_width))
    grad_Off_SOnOff = cp.zeros((20,10,1))
    SOnOff_ROn_PSC_s = cp.zeros((20,10,1,2))
    SOnOff_ROn_PSC_x = cp.zeros((20,10,1,2))
    SOnOff_ROn_PSC_F = cp.ones((20,10,1,2))
    SOnOff_ROn_PSC_P = cp.ones((20,10,1,2))
    SOnOff_ROn_PSC_q = cp.ones((20,10,1,2))
    spike_wrt_gsyn_SOnOff_ROn_accumulate = cp.zeros((20,10,1,loss_bin_width))
    grad_SOnOff_ROn = cp.zeros((20,10,1))
    grad_strf_gain = cp.zeros((20,10,1))
    grad_strf_latency = cp.zeros((20,10,1))
    grad_output_adaptation = cp.zeros((20,10,1))
