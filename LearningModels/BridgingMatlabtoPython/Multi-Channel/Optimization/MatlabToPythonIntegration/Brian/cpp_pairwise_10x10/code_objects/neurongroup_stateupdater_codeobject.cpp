...
const size_t _numv = 10;
    ...
    double* __restrict  _ptr_array_neurongroup_I_syn = _array_neurongroup_I_syn;
    ...
    for(int _idx=0; _idx<_N; _idx++)
    {
        ...
        double I_syn = _ptr_array_neurongroup_I_syn[_idx];
        ...
        if(not_refractory)
            v = _v;
        _ptr_array_neurongroup_I_syn[_idx] = I_syn;
