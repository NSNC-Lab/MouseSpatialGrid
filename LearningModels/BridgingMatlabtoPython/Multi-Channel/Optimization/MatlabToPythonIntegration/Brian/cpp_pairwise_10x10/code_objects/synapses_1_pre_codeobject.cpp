...
void _run_synapses_1_pre_codeobject()
{
    ...
    ///// CONSTANTS ///////////
    const size_t _numI_syn_post = 10;
...
const size_t _numw = _dynamic_array_synapses_1_w.size();
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_1__synaptic_post.size();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double I_syn_post = _ptr_array_neurongroup_1_I_syn[_postsynaptic_idx];
            const double w = _ptr_array_synapses_1_w[_idx];
            I_syn_post += w;
            _ptr_array_neurongroup_1_I_syn[_postsynaptic_idx] = I_syn_post;
