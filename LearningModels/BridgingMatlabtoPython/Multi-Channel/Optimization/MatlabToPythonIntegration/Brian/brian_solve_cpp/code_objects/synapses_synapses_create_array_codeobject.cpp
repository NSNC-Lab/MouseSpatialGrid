...
const int32_t N_post = 2;
const int32_t N_pre = 2;
...
const size_t _numsources = 2;
const size_t _numtargets = 2;
const size_t _num_postsynaptic_idx = _dynamic_array_synapses__synaptic_post.size();
const size_t _num_presynaptic_idx = _dynamic_array_synapses__synaptic_pre.size();
    ///// POINTERS ////////////
...
const size_t _old_num_synapses = _ptr_array_synapses_N[0];
...
const size_t newsize = _dynamic_array_synapses__synaptic_pre.size();
