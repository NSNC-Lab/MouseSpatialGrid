...
def main(trial_number,ps,scale_factor):
    ...
    S1OnOff_On_PSC_gSYN = ps[9]
    S1OnOff_On_PSC_fF = 0
    S1OnOff_On_PSC_fP = ps[10]
    ...
    R1On_S1OnOff_PSC_gSYN = ps[11]
    R1On_S1OnOff_PSC_fF = 0
    R1On_S1OnOff_PSC_fP = ps[12]
    ...
    R1Off_S1OnOff_PSC_gSYN = ps[13]
    R1Off_S1OnOff_PSC_fF = 0
    R1Off_S1OnOff_PSC_fP = ps[14]
    ...
    R1Off_Off_PSC_gSYN = ps[15]
    R1Off_Off_PSC_fF = 0
    R1Off_Off_PSC_fP = ps[16]
    ...
    S1OnOff_Off_PSC_gSYN = ps[17]
    S1OnOff_Off_PSC_fF = 0
    S1OnOff_Off_PSC_fP = ps[18]
    ...
    R2On_R1On_PSC_gSYN = ps[19]
    R2On_R1On_PSC_fF = 0
    R2On_R1On_PSC_fP = ps[20]
    ...
    S2OnOff_R1On_PSC_gSYN = ps[21]
    S2OnOff_R1On_PSC_fF = 0
    S2OnOff_R1On_PSC_fP = ps[22]
    ...
    R2On_S2OnOff_PSC_gSYN = ps[23]
    R2On_S2OnOff_PSC_fF = 0
    R2On_S2OnOff_PSC_fP = ps[24]
    ...
    for t in range(0,T):
        ...
        if np.any(mask):
            ...
            R1On_On_PSC_P[spikers,-1] = R1On_On_PSC_P[spikers,-1] * (1 - R1On_On_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            S1OnOff_On_PSC_P[spikers,-1] = S1OnOff_On_PSC_P[spikers,-1] * (1 - S1OnOff_On_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            R1On_S1OnOff_PSC_P[spikers,-1] = R1On_S1OnOff_PSC_P[spikers,-1] * (1 - R1On_S1OnOff_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            R1Off_S1OnOff_PSC_P[spikers,-1] = R1Off_S1OnOff_PSC_P[spikers,-1] * (1 - R1Off_S1OnOff_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            R1Off_Off_PSC_P[spikers,-1] = R1Off_Off_PSC_P[spikers,-1] * (1 - R1Off_Off_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            S1OnOff_Off_PSC_P[spikers,-1] = S1OnOff_Off_PSC_P[spikers,-1] * (1 - S1OnOff_Off_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            R2On_R1On_PSC_P[spikers,-1] = R2On_R1On_PSC_P[spikers,-1] * (1 - R2On_R1On_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            S2OnOff_R1On_PSC_P[spikers,-1] = S2OnOff_R1On_PSC_P[spikers,-1] * (1 - S2OnOff_R1On_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            R2On_S2OnOff_PSC_P[spikers,-1] = R2On_S2OnOff_PSC_P[spikers,-1] * (1 - R2On_S2OnOff_PSC_fP[spikers])
        ...
        if np.any(mask):
            ...
            S2OnOff_R1Off_PSC_P[spikers,-1] = S2OnOff_R1Off_PSC_P[spikers,-1] * (1 - S2OnOff_R1Off_PSC_fP[spikers])
