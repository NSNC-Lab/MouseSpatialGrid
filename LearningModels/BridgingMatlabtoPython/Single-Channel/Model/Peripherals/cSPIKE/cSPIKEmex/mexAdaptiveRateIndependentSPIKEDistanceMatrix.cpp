 ...
 * Version: 1.0
 *
 * Function: mexAdaptiveRateIndependentSPIKEDistanceMatrix
 * Input: SpikeData,threshold,startTime, endTime
 * output: ARI-SPIKE-DistanceMatrix
 *
 * Other: -
 */
...
#define output1 output[0]
    ...
    STs->AdaptiveRateIndependentSPIKEDistanceMatrix(valueOut, T1[0],T2[0],THR[0]);
