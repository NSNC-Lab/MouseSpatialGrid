...
def solve_run(on_input, off_input, noise_token, data, p):
    """
    CuPy GPU-accelerated version of solve_run.
    Inputs are numpy arrays, outputs are numpy arrays.
    ...
    On_ROn_tauR = 0.7
    On_ROn_PSC_delay = 3
    On_ROn_gSYN = p[0].reshape(16384, 1, 1)
    On_ROn_PSC_fF = 0
    On_ROn_PSC_fP = 0.1
    On_ROn_tauF = 180
    On_ROn_tauP = 30
    ...
    Off_ROn_tauR = 0.7
    Off_ROn_PSC_delay = 3
    Off_ROn_gSYN = p[1].reshape(16384, 1, 1)
    Off_ROn_PSC_fF = 0
    Off_ROn_PSC_fP = 0.1
    Off_ROn_tauF = 180
    Off_ROn_tauP = 30
    ...
    On_SOnOff_gSYN = p[2].reshape(16384, 1, 1)
    On_SOnOff_PSC_fF = 0
    ...
    Off_SOnOff_gSYN = p[3].reshape(16384, 1, 1)
    Off_SOnOff_PSC_fF = 0
    ...
    SOnOff_ROn_gSYN = p[4].reshape(16384, 1, 1)
    SOnOff_ROn_PSC_fF = 0
    ...
    On_V = cp.ones((16384,10,1,2)) * On_E_L
    On_g_ad = cp.zeros((16384,10,1,2))
    On_tspike = cp.ones((16384,10,1,5)) * -30
    On_buffer_index = cp.ones((16384,10,1))
    spike_wrt_tau_ad_On = cp.zeros((16384,10,1))
    spike_wrt_g_inc_On = cp.zeros((16384,10,1))
    Off_V = cp.ones((16384,10,1,2)) * Off_E_L
    Off_g_ad = cp.zeros((16384,10,1,2))
    Off_tspike = cp.ones((16384,10,1,5)) * -30
    Off_buffer_index = cp.ones((16384,10,1))
    spike_wrt_tau_ad_Off = cp.zeros((16384,10,1))
    spike_wrt_g_inc_Off = cp.zeros((16384,10,1))
    SOnOff_V = cp.ones((16384,10,1,2)) * SOnOff_E_L
    SOnOff_g_ad = cp.zeros((16384,10,1,2))
    SOnOff_tspike = cp.ones((16384,10,1,5)) * -30
    SOnOff_buffer_index = cp.ones((16384,10,1))
    spike_wrt_tau_ad_SOnOff = cp.zeros((16384,10,1))
    spike_wrt_g_inc_SOnOff = cp.zeros((16384,10,1))
    ROn_V = cp.ones((16384,10,1,2)) * ROn_E_L
    ROn_g_ad = cp.zeros((16384,10,1,2))
    ROn_tspike = cp.ones((16384,10,1,5)) * -30
    ROn_buffer_index = cp.ones((16384,10,1))
    ROn_spikes_holder = cp.zeros((16384,10,1,29801), dtype=cp.int8)
    On_SOnOff_PSC_s_holder = cp.zeros((16384,10,1,29801), dtype=cp.int8)
    Off_SOnOff_PSC_s_holder = cp.zeros((16384,10,1,29801), dtype=cp.int8)
    losses_holder = cp.zeros((16384,1,1,29801), dtype=cp.int8)
    ROn_noise_sn = cp.zeros((16384,10,1,2))
    ROn_noise_xn = cp.zeros((16384,10,1,2))
    spike_wrt_tau_ad_ROn = cp.zeros((16384,10,1))
    spike_wrt_g_inc_ROn = cp.zeros((16384,10,1))
    On_ROn_PSC_s = cp.zeros((16384,10,1,2))
    On_ROn_PSC_x = cp.zeros((16384,10,1,2))
    On_ROn_PSC_F = cp.ones((16384,10,1,2))
    On_ROn_PSC_P = cp.ones((16384,10,1,2))
    On_ROn_PSC_q = cp.ones((16384,10,1,2))
    spike_wrt_gsyn_On_ROn_accumulate = cp.zeros((16384,10,1,loss_bin_width))
    grad_On_ROn = cp.zeros((16384,10,1))
    Off_ROn_PSC_s = cp.zeros((16384,10,1,2))
    Off_ROn_PSC_x = cp.zeros((16384,10,1,2))
    Off_ROn_PSC_F = cp.ones((16384,10,1,2))
    Off_ROn_PSC_P = cp.ones((16384,10,1,2))
    Off_ROn_PSC_q = cp.ones((16384,10,1,2))
    spike_wrt_gsyn_Off_ROn_accumulate = cp.zeros((16384,10,1,loss_bin_width))
    grad_Off_ROn = cp.zeros((16384,10,1))
    On_SOnOff_PSC_s = cp.zeros((16384,10,1,2))
    On_SOnOff_PSC_x = cp.zeros((16384,10,1,2))
    On_SOnOff_PSC_F = cp.ones((16384,10,1,2))
    On_SOnOff_PSC_P = cp.ones((16384,10,1,2))
    On_SOnOff_PSC_q = cp.ones((16384,10,1,2))
    spike_wrt_gsyn_On_SOnOff_accumulate = cp.zeros((16384,10,1,loss_bin_width))
    grad_On_SOnOff = cp.zeros((16384,10,1))
    Off_SOnOff_PSC_s = cp.zeros((16384,10,1,2))
    Off_SOnOff_PSC_x = cp.zeros((16384,10,1,2))
    Off_SOnOff_PSC_F = cp.ones((16384,10,1,2))
    Off_SOnOff_PSC_P = cp.ones((16384,10,1,2))
    Off_SOnOff_PSC_q = cp.ones((16384,10,1,2))
    spike_wrt_gsyn_Off_SOnOff_accumulate = cp.zeros((16384,10,1,loss_bin_width))
    grad_Off_SOnOff = cp.zeros((16384,10,1))
    SOnOff_ROn_PSC_s = cp.zeros((16384,10,1,2))
    SOnOff_ROn_PSC_x = cp.zeros((16384,10,1,2))
    SOnOff_ROn_PSC_F = cp.ones((16384,10,1,2))
    SOnOff_ROn_PSC_P = cp.ones((16384,10,1,2))
    SOnOff_ROn_PSC_q = cp.ones((16384,10,1,2))
    spike_wrt_gsyn_SOnOff_ROn_accumulate = cp.zeros((16384,10,1,loss_bin_width))
    grad_SOnOff_ROn = cp.zeros((16384,10,1))
    ...
    return cp.asnumpy(ROn_spikes_holder)
