def Declare_Architecture(opts):
    ...
    On_R1_synapse = Lif_Synapse.Build_Vars(name = 'On_ROn',fP=0.1,gSYN=0.02,tauP=30, tauR=0.7, tauD=1.5,delay=1)
    ...
    Off_S1_synapse = Lif_Synapse.Build_Vars(name = 'Off_SOnOff', gSYN = 0.005, fP = 0.0,tauP=80, tauR=0.1, tauD=1, delay=3)
    S1_R1_synapse = Lif_Synapse.Build_Vars(name = 'SOnOff_ROn',gSYN=0.005,fP=0.5,tauP=120, tauR=1, tauD=4.5,ESYN=-80, delay=0.5)
