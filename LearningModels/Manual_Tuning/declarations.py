def Declare_Architecture(opts):
    ...
    PV_1 = Lif_Neuron.Build_Vars(name = 'SOnOff',is_output=0, g_L = 1/100, g_inc = 0.0000, E_L = -57, V_reset = -52, t_ref = 0.5,C=0.01)
    Relay_1 = Lif_Neuron.Build_Vars(name = 'ROn',is_output=1,is_noise=1, g_inc = 0.0001, tau_ad = 10,final_grad_node = 1,nSYN=0.015,C=0.1, t_ref = 1)
