def Declare_Architecture(opts):
    ...
    Relay_1 = Lif_Neuron.Build_Vars(name = 'ROn',is_output=1,is_noise=1, g_inc = 0.008, tau_ad = 100,final_grad_node = 1,nSYN=0.015,C=0.1, t_ref = 4)
    ...
    On_R1_synapse = Lif_Synapse.Build_Vars(name = 'On_ROn',fP=0.1,gSYN=0.03,tauP=30, tauR=0.7, tauD=1.5,delay=1)
    Off_R1_synapse = Lif_Synapse.Build_Vars(name = 'Off_ROn',fP=0.1,gSYN=0,tauP=30, tauR=0.7, tauD=1.5,delay=1)
    On_S1_synapse = Lif_Synapse.Build_Vars(name = 'On_SOnOff', gSYN = 0, fP = 0.2,tauP=80, tauR=0.1, tauD=1, delay=3)
    Off_S1_synapse = Lif_Synapse.Build_Vars(name = 'Off_SOnOff', gSYN = 0.2, fP = 0.0,tauP=80, tauR=0.1, tauD=1, delay=3)
    S1_R1_synapse = Lif_Synapse.Build_Vars(name = 'SOnOff_ROn',gSYN=0.4,fP=0.5,tauP=120, tauR=1, tauD=4.5,ESYN=-80, delay=0.5)
