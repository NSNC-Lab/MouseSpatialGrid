...
plot(movmean(mean(mse),5)); hold on
...
names = {'gsyn On->ROn','gsyn On->SOnOff','gsyn Off->SOnOff','gsyn SOnOff->ROn','tau ad ROn','Ginc ROn','tauP On->ROn','tauP On->SOnOff','tauP Off->SOnOff','TauP SOnOff->Ron'}; 

%spike_wrt_gsyn_On_ROn,spike_wrt_gsyn_On_SOnOff,spike_wrt_gsyn_Off_SOnOff,spike_wrt_gsyn_SOnOff_ROn,spike_wrt_tau_ad_ROn,spike_wrt_g_inc_ROn,spike_wrt_tauP_On_ROn,spike_wrt_tauP_On_SOnOff,spike_wrt_tauP_Off_SOnOff,spike_wrt_tauP_SOnOff_ROn
