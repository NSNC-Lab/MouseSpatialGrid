...
def main(trial_number,ps,scale_factor):
    ...
    R2On_t_ref = ps[15]
    S2OnOff_t_ref = ps[16]
    On_On_IC_g_postIC = ps[17]
    Off_Off_IC_g_postIC = ps[18]
    ...
    R2On_R2On_iNoise_V3_sn = np.ones((400,2)) * [0, 0]
    R2On_R2On_iNoise_V3_xn = np.ones((400,2)) * [0, 0]
    ...
    Off_Off_IC_input = genPoissonInputs.gen_poisson_inputs(trial_number,Off_Off_IC_locNum,Off_Off_IC_label,Off_Off_IC_t_ref,Off_Off_IC_t_ref_rel,Off_Off_IC_rec,scale_factor,"Layer23")
    ...
    for t in range(0,T):
        ...
        dv2_dOn_tref[:,1] = np.squeeze(np.sum(-(On_V[:,-1]-On_V_reset)[:,None]*np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None]))))/(1+np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None])))))**2,axis=1))
        dspike_dOn_tref = dukdv2On_V*dv2_dOn_tref[:,0]
        dv2_dOff_tref[:,0] = dv2_dOff_tref[:,1]
        dv2_dOff_tref[:,1] = np.squeeze(np.sum(-(Off_V[:,-1]-Off_V_reset)[:,None]*np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None]))))/(1+np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None])))))**2,axis=1))
        dspike_dOff_tref = dukdv2Off_V*dv2_dOff_tref[:,0]
        dv2_dR1On_tref[:,0] = dv2_dR1On_tref[:,1]
        dv2_dR1On_tref[:,1] = np.squeeze(np.sum(-(R1On_V[:,-1]-R1On_V_reset)[:,None]*np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None]))))/(1+np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None])))))**2,axis=1))
        dspike_dR1On_tref = dukdv2R1On_V*dv2_dR1On_tref[:,0]
        dv2_dR1Off_tref[:,0] = dv2_dR1Off_tref[:,1]
        dv2_dR1Off_tref[:,1] = np.squeeze(np.sum(-(R1Off_V[:,-1]-R1Off_V_reset)[:,None]*np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None]))))/(1+np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None])))))**2,axis=1))
        dspike_dR1Off_tref = dukdv2R1Off_V*dv2_dR1Off_tref[:,0]
        dv2_dS1OnOff_tref[:,0] = dv2_dS1OnOff_tref[:,1]
        dv2_dS1OnOff_tref[:,1] = np.squeeze(np.sum(-(S1OnOff_V[:,-1]-S1OnOff_V_reset)[:,None]*np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None]))))/(1+np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None])))))**2,axis=1))
        dspike_dS1OnOff_tref = dukdv2S1OnOff_V*dv2_dS1OnOff_tref[:,0]
        dv2_dR2On_tref[:,0] = dv2_dR2On_tref[:,1]
        dv2_dR2On_tref[:,1] = np.squeeze(np.sum(-(R2On_V[:,-1]-R2On_V_reset)[:,None]*np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None]))))/(1+np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None])))))**2,axis=1))
        dspike_dR2On_tref = dukdv2R2On_V*dv2_dR2On_tref[:,0]
        dv2_dS2OnOff_tref[:,0] = dv2_dS2OnOff_tref[:,1]
        dv2_dS2OnOff_tref[:,1] = np.squeeze(np.sum(-(S2OnOff_V[:,-1]-S2OnOff_V_reset)[:,None]*np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None]))))/(1+np.squeeze(np.exp(-(helper[t]-(np.squeeze(S2OnOff_tspike)+S2OnOff_t_ref[:,None])))))**2,axis=1))
        ...
        #Build T_ref derivs
        dtref_On = dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_On_PSC*dR1On_On_PSC_dUk*dspike_dOn_tref+dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_On_PSC*dS1OnOff_On_PSC_dUk*dspike_dOn_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_V*dv_dR1Off_S1OnOff_PSC*dR1Off_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_On_PSC*dS1OnOff_On_PSC_dUk*dspike_dOn_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_On_PSC*dR1On_On_PSC_dUk*dspike_dOn_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_On_PSC*dS1OnOff_On_PSC_dUk*dspike_dOn_tref
        dtref_Off = dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_Off_PSC*dS1OnOff_Off_PSC_dUk*dspike_dOff_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_V*dv_dR1Off_Off_PSC*dR1Off_Off_PSC_dUk*dspike_dOff_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_V*dv_dR1Off_S1OnOff_PSC*dR1Off_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_Off_PSC*dS1OnOff_Off_PSC_dUk*dspike_dOff_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_Off_PSC*dS1OnOff_Off_PSC_dUk*dspike_dOff_tref
        dtref_R1On = dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_tref
        dtref_R1Off = dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_tref
        dtref_S1OnOff = dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_V*dv_dR1Off_S1OnOff_PSC*dR1Off_S1OnOff_PSC_dUk*dspike_dS1OnOff_tref+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_tref
        dtref_R2On = dspike_dR2On_tref
        dtref_S2OnOff = dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_tref


        #Build Input derivs
        dinput_On = dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_On_PSC*dR1On_On_PSC_dUk*dspike_dOn_V*dv_dOn_input+dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_On_PSC*dS1OnOff_On_PSC_dUk*dspike_dOn_V*dv_dOn_input+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_V*dv_dR1Off_S1OnOff_PSC*dR1Off_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_On_PSC*dS1OnOff_On_PSC_dUk*dspike_dOn_V*dv_dOn_input+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_On_PSC*dR1On_On_PSC_dUk*dspike_dOn_V*dv_dOn_input+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_On_PSC*dS1OnOff_On_PSC_dUk*dspike_dOn_V*dv_dOn_input
        dinput_Off = dspike_dR2On_V*dv_dR2On_R1On_PSC*dR2On_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_Off_PSC*dS1OnOff_Off_PSC_dUk*dspike_dOff_V*dv_dOff_input+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_V*dv_dR1Off_Off_PSC*dR1Off_Off_PSC_dUk*dspike_dOff_V*dv_dOff_input+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1Off_PSC*dS2OnOff_R1Off_PSC_dUk*dspike_dR1Off_V*dv_dR1Off_S1OnOff_PSC*dR1Off_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_Off_PSC*dS1OnOff_Off_PSC_dUk*dspike_dOff_V*dv_dOff_input+dspike_dR2On_V*dv_dR2On_S2OnOff_PSC*dR2On_S2OnOff_PSC_dUk*dspike_dS2OnOff_V*dv_dS2OnOff_R1On_PSC*dS2OnOff_R1On_PSC_dUk*dspike_dR1On_V*dv_dR1On_S1OnOff_PSC*dR1On_S1OnOff_PSC_dUk*dspike_dS1OnOff_V*dv_dS1OnOff_Off_PSC*dS1OnOff_Off_PSC_dUk*dspike_dOff_V*dv_dOff_input


    return R2On_V_spikes_holder, [dGSYNR1On_On, dGSYNS1OnOff_On, dGSYNR1On_S1OnOff, dGSYNR1Off_S1OnOff, dGSYNR1Off_Off, dGSYNS1OnOff_Off, dGSYNR2On_R1On, dGSYNS2OnOff_R1On, dGSYNR2On_S2OnOff, dGSYNS2OnOff_R1Off, dtref_On, dtref_Off, dtref_R1On, dtref_R1Off, dtref_S1OnOff, dtref_R2On, dtref_S2OnOff, dinput_On, dinput_Off]