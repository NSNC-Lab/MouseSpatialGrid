...
ParamsReturned = py.Solve_File_Generator_Manual.build_ODE(p);

mod = py.importlib.import_module('generated2');
py.importlib.reload(mod);
...
% endz
x = py.generated2.main(); %This is declared in python rn so the 1 isn't actually doing anything
