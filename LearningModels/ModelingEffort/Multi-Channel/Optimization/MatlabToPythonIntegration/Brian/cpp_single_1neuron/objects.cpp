...
const int _num__array_neurongroup_1_I_syn = 1;
...
const int _num__array_neurongroup_I_syn = 1;
...
void _init_arrays()
{
    ...
    _array_neurongroup_1_I_syn = new double[1];
    
    for(int i=0; i<1; i++) _array_neurongroup_1_I_syn[i] = 0;
    ...
    _array_neurongroup_I_syn = new double[1];
    
    for(int i=0; i<1; i++) _array_neurongroup_I_syn[i] = 0;
...
void _write_arrays()
{
    ...
    {
        outfile__array_neurongroup_1_I_syn.write(reinterpret_cast<char*>(_array_neurongroup_1_I_syn), 1*sizeof(_array_neurongroup_1_I_syn[0]));
    ...
    {
        outfile__array_neurongroup_I_syn.write(reinterpret_cast<char*>(_array_neurongroup_I_syn), 1*sizeof(_array_neurongroup_I_syn[0]));
