...
void _before_run_synapses_1_pre_push_spikes()
{
    ...
    ///// CONSTANTS ///////////
    const int32_t _n_sources = 10;
const int32_t _n_targets = 10;
const size_t _num_source_dt = 1;
const size_t _num_spikespace = 11;
double* const _array_synapses_1_delay = _dynamic_array_synapses_1_delay.empty()? 0 : &_dynamic_array_synapses_1_delay[0];
const size_t _numdelay = _dynamic_array_synapses_1_delay.size();
    ///// POINTERS ////////////
        
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    int32_t* __restrict  _ptr_array_neurongroup__spikespace = _array_neurongroup__spikespace;
    double* __restrict  _ptr_array_synapses_1_delay = _array_synapses_1_delay;

    std::vector<double> &real_delays = _dynamic_array_synapses_1_delay;
    ...
    const size_t n_synapses = synapses_1_pre.sources.size();
    synapses_1_pre.prepare(_n_sources,
                           _n_targets,
