...
const size_t _numI_syn = 10;
const int32_t N = 10;
const double R = 100000000.0;
const size_t _numdt = 1;
const size_t _numlastspike = 10;
const size_t _numnot_refractory = 10;
const size_t _numt = 1;
const double tau = 0.02;
const double tau_syn = 0.005;
const size_t _numv = 10;
    ///// POINTERS ////////////
        
    double* __restrict  _ptr_array_neurongroup_1_I_syn = _array_neurongroup_1_I_syn;
