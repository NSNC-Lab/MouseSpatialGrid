...
%Took out 4/11 not sure why it is being used. Will come back to this IB.
...
%Changed to 0 just to see what would happen
%We expect to see
% 1. Reduced discrimtiability due to noise. No effect due to inhibition.
%varies(end).range = 0; 
varies(end).range = -1; 

%STRF CHANGED TO 7 CHANGE BACK
%Still need to rerun STRF
