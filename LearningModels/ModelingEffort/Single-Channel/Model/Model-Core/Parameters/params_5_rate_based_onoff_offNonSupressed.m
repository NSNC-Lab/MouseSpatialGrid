...
%Try dense connections (on->off off->on)
...
% E->E connections
varies(end+1).conxn = '(On->R1On,R1On->R2On,Off->R1Off,R1Off->R2Off,Off->R1On,R1Off->R2On,On->R1Off,R1On->R2Off)';
varies(end).param = 'gSYN';
varies(end).range = 0.02;

% Offset connections
varies(end+1).conxn = '(Off->R1Off,R1Off->R2Off,Off->R1On,R1Off->R2On,Off->S1OnOff,R1Off->S2OnOff)';
varies(end).param = 'fP';
varies(end).range = 0;
