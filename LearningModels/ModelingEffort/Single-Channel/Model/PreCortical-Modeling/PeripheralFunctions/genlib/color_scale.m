...
% Lab = [L, a, b];
% cform = makecform('lab2srgb'); % This command need image processing toolbox
% map = applycform(Lab, cform); % This command need image processing toolbox

map = double(permute(Lab2RGB(L, a, b), [1 3 2]))/255;