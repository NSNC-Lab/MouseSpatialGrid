...
score = ((pc(15).perf.RISPIKE./pc(15).perf.ISI));
%score= ((pc(15).perf.RISPIKE./pc(15).perf.ISI))
%score = score +1

score_mean = mean(score);

score = score - score_mean;
...
kernel_size = 7; % Define the size of the kernel (e.g., 3x3)
%kernal = [1,1,1;1,1,1;1,1,1];
average_kernel = ones(kernel_size) / (kernel_size^2); % Define the average kernel%(kernal/(sum(kernal)));

% Perform 2D convolution
gridNums1 = conv2(input_matrix, average_kernel, 'same');

gridNums1 = gridNums1 + score_mean;

%gridNums1 = gridNums1([3:10],[3:10])
...
% % 
% % % Define your input matrix
% % input_matrix = approximates; % Example random input matrix of size 10x12
% % 
% % % Define your average kernel
...
% % 
% % % Perform 2D convolution
% % gridNums = conv2(input_matrix, average_kernel, 'same')
% 
% 
