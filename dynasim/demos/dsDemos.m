...
data=dsSimulate(eqns, 'time_limits',[0 1000],'mex_flag',1);
...
LIF={
    ...
    'if(any(any(V > V_thresh)))(V=V_spike)'
    'if(any(any(t<tspike+tref,1)))(V=reset)'
    'tau=10; tref=10; E=-70; thresh=-55; reset=-75; V_spike = 45; R=9; I=1.55; noise=100'
