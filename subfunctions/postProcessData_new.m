...
for vv = 1:jump % for each varied parameter
    ...
    for currentPop = 1:nPops
        ...
        for channelNum = 1:popSizes(currentPop)
            ...
            if(plot_all == 1)
                if(strcmp(popNames{currentPop},'C') || strcmp(popNames{currentPop},'ROn')|| strcmp(popNames{currentPop},'On') || strcmp(popNames{currentPop},'Off') ||strcmp(popNames{currentPop},'X')|| strcmp(popNames{currentPop},'R1On')|| strcmp(popNames{currentPop},'R2On')|| strcmp(popNames{currentPop},'R1Off')|| strcmp(popNames{currentPop},'R2Off')|| strcmp(popNames{currentPop},'S1OnOff')|| strcmp(popNames{currentPop},'S2OnOff')|| strcmp(popNames{currentPop},'SOnOff'))
                         % for each trial
