...
best_wt(cases) = gsyn_range(best_iteration(cases));
best_perf(cases,:) = perf(best_iteration(cases),:);
...
best_two_wts(cases,:) = all_wt_combos(best_iteration(cases),:);
twochan_perf(cases,:) = perf(best_iteration(cases),:);
