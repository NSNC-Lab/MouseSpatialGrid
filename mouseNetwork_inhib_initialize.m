function [simdata,DirPart] = mouseNetwork_inhib_initialize(varies,xrNetcons,Cnoise_coloc,ICdirPath,...
...
for z = subz
    ...
    temp = mouse_network_inhib(study_dir,time_end,varies,xrNetcons,restricts);
