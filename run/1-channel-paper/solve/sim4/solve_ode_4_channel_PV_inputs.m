function [T,On_V,On_g_ad,Off_V,Off_g_ad,R1On_V,R1On_g_ad,S1OnOff_V,S1OnOff_g_ad,R2On_V,R2On_g_ad,S2OnOff_V,S2OnOff_g_ad,R1On_On_PSC_s,R1On_On_PSC_x,R1On_On_PSC_F,R1On_On_PSC_P,R1On_On_PSC_q,R1On_Off_PSC_s,R1On_Off_PSC_x,R1On_Off_PSC_F,R1On_Off_PSC_P,R1On_Off_PSC_q,S1OnOff_On_PSC_s,S1OnOff_On_PSC_x,S1OnOff_On_PSC_F,S1OnOff_On_PSC_P,S1OnOff_On_PSC_q,S1OnOff_Off_PSC_s,S1OnOff_Off_PSC_x,S1OnOff_Off_PSC_F,S1OnOff_Off_PSC_P,S1OnOff_Off_PSC_q,R1On_S1OnOff_PSC_s,R1On_S1OnOff_PSC_x,R1On_S1OnOff_PSC_F,R1On_S1OnOff_PSC_P,R1On_S1OnOff_PSC_q,R2On_R1On_PSC_s,R2On_R1On_PSC_x,R2On_R1On_PSC_F,R2On_R1On_PSC_P,R2On_R1On_PSC_q,S2OnOff_R1On_PSC_s,S2OnOff_R1On_PSC_x,S2OnOff_R1On_PSC_F,S2OnOff_R1On_PSC_P,S2OnOff_R1On_PSC_q,R2On_S2OnOff_PSC_s,R2On_S2OnOff_PSC_x,R2On_S2OnOff_PSC_F,R2On_S2OnOff_PSC_P,R2On_S2OnOff_PSC_q,R2On_R2On_iNoise_V3_sn,R2On_R2On_iNoise_V3_xn,On_V_spikes,Off_V_spikes,R1On_V_spikes,S1OnOff_V_spikes,R2On_V_spikes,S2OnOff_V_spikes,On_On_IC_iIC,Off_Off_IC_iIC,R1On_On_PSC_syn,R1On_Off_PSC_syn,S1OnOff_On_PSC_syn,S1OnOff_Off_PSC_syn,R1On_S1OnOff_PSC_syn,R2On_R1On_PSC_syn,S2OnOff_R1On_PSC_syn,R2On_S2OnOff_PSC_syn,On_R,On_tau,On_Imask,Off_R,Off_tau,Off_Imask,R1On_R,R1On_tau,R1On_Imask,S1OnOff_R,S1OnOff_tau,S1OnOff_Imask,R2On_R,R2On_tau,R2On_Imask,S2OnOff_R,S2OnOff_tau,S2OnOff_Imask,On_On_IC_netcon,On_On_IC_input,Off_Off_IC_netcon,Off_Off_IC_input,R1On_On_PSC_netcon,R1On_On_PSC_scale,R1On_Off_PSC_netcon,R1On_Off_PSC_scale,S1OnOff_On_PSC_netcon,S1OnOff_On_PSC_scale,S1OnOff_Off_PSC_netcon,S1OnOff_Off_PSC_scale,R1On_S1OnOff_PSC_netcon,R1On_S1OnOff_PSC_scale,R2On_R1On_PSC_netcon,R2On_R1On_PSC_scale,S2OnOff_R1On_PSC_netcon,S2OnOff_R1On_PSC_scale,R2On_S2OnOff_PSC_netcon,R2On_S2OnOff_PSC_scale,R2On_R2On_iNoise_V3_netcon,R2On_R2On_iNoise_V3_token,R2On_R2On_iNoise_V3_scale]=solve_ode(tspan, downsample_factor, random_seed, solver, disk_flag, dt, datafile, mex_flag, verbose_flag, On_C, On_g_L, On_E_L, On_noise, On_t_ref, On_E_k, On_tau_ad, On_g_inc, On_Itonic, On_V_thresh, On_V_reset, On_Npop, Off_C, Off_g_L, Off_E_L, Off_noise, Off_t_ref, Off_E_k, Off_tau_ad, Off_g_inc, Off_Itonic, Off_V_thresh, Off_V_reset, Off_Npop, R1On_C, R1On_g_L, R1On_E_L, R1On_noise, R1On_t_ref, R1On_E_k, R1On_tau_ad, R1On_g_inc, R1On_Itonic, R1On_V_thresh, R1On_V_reset, R1On_Npop, S1OnOff_C, S1OnOff_g_L, S1OnOff_E_L, S1OnOff_noise, S1OnOff_t_ref, S1OnOff_E_k, S1OnOff_tau_ad, S1OnOff_g_inc, S1OnOff_Itonic, S1OnOff_V_thresh, S1OnOff_V_reset, S1OnOff_Npop, R2On_C, R2On_g_L, R2On_E_L, R2On_noise, R2On_t_ref, R2On_E_k, R2On_tau_ad, R2On_g_inc, R2On_Itonic, R2On_V_thresh, R2On_V_reset, R2On_Npop, S2OnOff_C, S2OnOff_g_L, S2OnOff_E_L, S2OnOff_noise, S2OnOff_t_ref, S2OnOff_E_k, S2OnOff_tau_ad, S2OnOff_g_inc, S2OnOff_Itonic, S2OnOff_V_thresh, S2OnOff_V_reset, S2OnOff_Npop, On_On_IC_trial, On_On_IC_locNum, On_On_IC_label, On_On_IC_t_ref, On_On_IC_t_ref_rel, On_On_IC_rec, On_On_IC_g_postIC, On_On_IC_E_exc, Off_Off_IC_trial, Off_Off_IC_locNum, Off_Off_IC_label, Off_Off_IC_t_ref, Off_Off_IC_t_ref_rel, Off_Off_IC_rec, Off_Off_IC_g_postIC, Off_Off_IC_E_exc, R1On_On_PSC_ESYN, R1On_On_PSC_tauD, R1On_On_PSC_tauR, R1On_On_PSC_delay, R1On_On_PSC_gSYN, R1On_On_PSC_fF, R1On_On_PSC_fP, R1On_On_PSC_tauF, R1On_On_PSC_tauP, R1On_On_PSC_maxF, R1On_Off_PSC_ESYN, R1On_Off_PSC_tauD, R1On_Off_PSC_tauR, R1On_Off_PSC_delay, R1On_Off_PSC_gSYN, R1On_Off_PSC_fF, R1On_Off_PSC_fP, R1On_Off_PSC_tauF, R1On_Off_PSC_tauP, R1On_Off_PSC_maxF, S1OnOff_On_PSC_ESYN, S1OnOff_On_PSC_tauD, S1OnOff_On_PSC_tauR, S1OnOff_On_PSC_delay, S1OnOff_On_PSC_gSYN, S1OnOff_On_PSC_fF, S1OnOff_On_PSC_fP, S1OnOff_On_PSC_tauF, S1OnOff_On_PSC_tauP, S1OnOff_On_PSC_maxF, S1OnOff_Off_PSC_ESYN, S1OnOff_Off_PSC_tauD, S1OnOff_Off_PSC_tauR, S1OnOff_Off_PSC_delay, S1OnOff_Off_PSC_gSYN, S1OnOff_Off_PSC_fF, S1OnOff_Off_PSC_fP, S1OnOff_Off_PSC_tauF, S1OnOff_Off_PSC_tauP, S1OnOff_Off_PSC_maxF, R1On_S1OnOff_PSC_ESYN, R1On_S1OnOff_PSC_tauD, R1On_S1OnOff_PSC_tauR, R1On_S1OnOff_PSC_delay, R1On_S1OnOff_PSC_gSYN, R1On_S1OnOff_PSC_fF, R1On_S1OnOff_PSC_fP, R1On_S1OnOff_PSC_tauF, R1On_S1OnOff_PSC_tauP, R1On_S1OnOff_PSC_maxF, R2On_R1On_PSC_ESYN, R2On_R1On_PSC_tauD, R2On_R1On_PSC_tauR, R2On_R1On_PSC_delay, R2On_R1On_PSC_gSYN, R2On_R1On_PSC_fF, R2On_R1On_PSC_fP, R2On_R1On_PSC_tauF, R2On_R1On_PSC_tauP, R2On_R1On_PSC_maxF, S2OnOff_R1On_PSC_ESYN, S2OnOff_R1On_PSC_tauD, S2OnOff_R1On_PSC_tauR, S2OnOff_R1On_PSC_delay, S2OnOff_R1On_PSC_gSYN, S2OnOff_R1On_PSC_fF, S2OnOff_R1On_PSC_fP, S2OnOff_R1On_PSC_tauF, S2OnOff_R1On_PSC_tauP, S2OnOff_R1On_PSC_maxF, R2On_S2OnOff_PSC_ESYN, R2On_S2OnOff_PSC_tauD, R2On_S2OnOff_PSC_tauR, R2On_S2OnOff_PSC_delay, R2On_S2OnOff_PSC_gSYN, R2On_S2OnOff_PSC_fF, R2On_S2OnOff_PSC_fP, R2On_S2OnOff_PSC_tauF, R2On_S2OnOff_PSC_tauP, R2On_S2OnOff_PSC_maxF, R2On_R2On_iNoise_V3_FR, R2On_R2On_iNoise_V3_sigma, R2On_R2On_iNoise_V3_dt, R2On_R2On_iNoise_V3_nSYN, R2On_R2On_iNoise_V3_simlen, R2On_R2On_iNoise_V3_tauD_N, R2On_R2On_iNoise_V3_tauR_N, R2On_R2On_iNoise_V3_E_exc)
...
for k=2:ntime
  ...
  S2OnOff_V_k1 = ( (S2OnOff_E_L-S2OnOff_V(1,:)) - S2OnOff_R*S2OnOff_g_ad(1,:).*(S2OnOff_V(1,:)-S2OnOff_E_k) - S2OnOff_R*((((S2OnOff_R1On_PSC_gSYN.*(S2OnOff_R1On_PSC_s(1,:)*S2OnOff_R1On_PSC_netcon).*(S2OnOff_V(1,:)-S2OnOff_R1On_PSC_ESYN))))) + S2OnOff_R*S2OnOff_Itonic.*S2OnOff_Imask + S2OnOff_R*S2OnOff_noise.*randn(1,S2OnOff_Npop) ) / S2OnOff_tau;
