...
R1Off_On_PSC_netcon = eye(On_Npop,R1Off_Npop);
R1Off_On_PSC_scale = (R1Off_On_PSC_tauD/R1Off_On_PSC_tauR)^(R1Off_On_PSC_tauR/(R1Off_On_PSC_tauD-R1Off_On_PSC_tauR));
...
R1Off_On_PSC_s = zeros(2,On_Npop);
R1Off_On_PSC_s(1,:) =  zeros(1,On_Npop);
R1Off_On_PSC_x = zeros(2,On_Npop);
R1Off_On_PSC_x(1,:) =  zeros(1,On_Npop);
R1Off_On_PSC_F = zeros(2,On_Npop);
R1Off_On_PSC_F(1,:) =  ones(1,On_Npop);
R1Off_On_PSC_P = zeros(2,On_Npop);
R1Off_On_PSC_P(1,:) =  ones(1,On_Npop);
R1Off_On_PSC_q = zeros(2,On_Npop);
R1Off_On_PSC_q(1,:) =  ones(1,On_Npop);
...
R1Off_On_PSC_syn = zeros(nsamp,R1Off_Npop);
R1Off_On_PSC_syn(1,:)=R1Off_On_PSC_gSYN.*(R1Off_On_PSC_s(1,:)*R1Off_On_PSC_netcon).*(R1Off_V(1,:)-R1Off_On_PSC_ESYN);
...
for k=2:ntime
  ...
  R1On_V_k1 = ( (R1On_E_L-R1On_V(1,:)) - R1On_R*R1On_g_ad(1,:).*(R1On_V(1,:)-R1On_E_k) - R1On_R*((((R1On_Off_PSC_gSYN.*(R1On_Off_PSC_s(1,:)*R1On_Off_PSC_netcon).*(R1On_V(1,:)-R1On_Off_PSC_ESYN))))+((((R1On_S1OnOff_PSC_gSYN.*(R1On_S1OnOff_PSC_s(1,:)*R1On_S1OnOff_PSC_netcon).*(R1On_V(1,:)-R1On_S1OnOff_PSC_ESYN)))))) + R1On_R*R1On_Itonic.*R1On_Imask + R1On_R*R1On_noise.*randn(1,R1On_Npop) ) / R1On_tau;
  R1On_g_ad_k1 = -R1On_g_ad(1,:) / R1On_tau_ad;
  R1Off_V_k1 = ( (R1Off_E_L-R1Off_V(1,:)) - R1Off_R*R1Off_g_ad(1,:).*(R1Off_V(1,:)-R1Off_E_k) - R1Off_R*((((R1Off_S1OnOff_PSC_gSYN.*(R1Off_S1OnOff_PSC_s(1,:)*R1Off_S1OnOff_PSC_netcon).*(R1Off_V(1,:)-R1Off_S1OnOff_PSC_ESYN))))+((((R1Off_On_PSC_gSYN.*(R1Off_On_PSC_s(1,:)*R1Off_On_PSC_netcon).*(R1Off_V(1,:)-R1Off_On_PSC_ESYN)))))) + R1Off_R*R1Off_Itonic.*R1Off_Imask + R1Off_R*R1Off_noise.*randn(1,R1Off_Npop) ) / R1Off_tau;
  ...
  R1On_Off_PSC_s_k1 = ( R1On_Off_PSC_scale * R1On_Off_PSC_x(1,:) - R1On_Off_PSC_s(1,:) )/R1On_Off_PSC_tauR;
  R1On_Off_PSC_x_k1 = -R1On_Off_PSC_x(1,:)/R1On_Off_PSC_tauD;
  R1On_Off_PSC_F_k1 = (1 - R1On_Off_PSC_F(1,:))/R1On_Off_PSC_tauF;
  R1On_Off_PSC_P_k1 = (1 - R1On_Off_PSC_P(1,:))/R1On_Off_PSC_tauP;
  R1On_Off_PSC_q_k1 = 0;
  ...
  R1Off_On_PSC_s_k1 = ( R1Off_On_PSC_scale * R1Off_On_PSC_x(1,:) - R1Off_On_PSC_s(1,:) )/R1Off_On_PSC_tauR;
  R1Off_On_PSC_x_k1 = -R1Off_On_PSC_x(1,:)/R1Off_On_PSC_tauD;
  R1Off_On_PSC_F_k1 = (1 - R1Off_On_PSC_F(1,:))/R1Off_On_PSC_tauF;
  R1Off_On_PSC_P_k1 = (1 - R1Off_On_PSC_P(1,:))/R1Off_On_PSC_tauP;
  R1Off_On_PSC_q_k1 = 0;
  ...
  R1On_Off_PSC_s(2,:) = R1On_Off_PSC_s(1,:)+dt*R1On_Off_PSC_s_k1;
  R1On_Off_PSC_x(2,:) = R1On_Off_PSC_x(1,:)+dt*R1On_Off_PSC_x_k1;
  R1On_Off_PSC_F(2,:) = R1On_Off_PSC_F(1,:)+dt*R1On_Off_PSC_F_k1;
  R1On_Off_PSC_P(2,:) = R1On_Off_PSC_P(1,:)+dt*R1On_Off_PSC_P_k1;
  R1On_Off_PSC_q(2,:) = R1On_Off_PSC_q(1,:)+dt*R1On_Off_PSC_q_k1;
  ...
  R1Off_On_PSC_s(2,:) = R1Off_On_PSC_s(1,:)+dt*R1Off_On_PSC_s_k1;
  R1Off_On_PSC_x(2,:) = R1Off_On_PSC_x(1,:)+dt*R1Off_On_PSC_x_k1;
  R1Off_On_PSC_F(2,:) = R1Off_On_PSC_F(1,:)+dt*R1Off_On_PSC_F_k1;
  R1Off_On_PSC_P(2,:) = R1Off_On_PSC_P(1,:)+dt*R1Off_On_PSC_P_k1;
  R1Off_On_PSC_q(2,:) = R1Off_On_PSC_q(1,:)+dt*R1Off_On_PSC_q_k1;
  ...
  if conditional_test, R1On_Off_PSC_x(2,conditional_indx) = R1On_Off_PSC_x(2,conditional_indx) + R1On_Off_PSC_q(2,conditional_indx);R1On_Off_PSC_q(2,conditional_indx) = R1On_Off_PSC_F(2,conditional_indx).*R1On_Off_PSC_P(2,conditional_indx);R1On_Off_PSC_F(2,conditional_indx) = R1On_Off_PSC_F(2,conditional_indx) + R1On_Off_PSC_fF*(R1On_Off_PSC_maxF-R1On_Off_PSC_F(2,conditional_indx)); R1On_Off_PSC_P(2,conditional_indx) = R1On_Off_PSC_P(2,conditional_indx)*(1 - R1On_Off_PSC_fP); end
  ...
  conditional_test=any(any(t == On_tspike+R1Off_On_PSC_delay,1));
  conditional_indx=(any(t == On_tspike+R1Off_On_PSC_delay,1));
  if conditional_test, R1Off_On_PSC_x(2,conditional_indx) = R1Off_On_PSC_x(2,conditional_indx) + R1Off_On_PSC_q(2,conditional_indx);R1Off_On_PSC_q(2,conditional_indx) = R1Off_On_PSC_F(2,conditional_indx).*R1Off_On_PSC_P(2,conditional_indx);R1Off_On_PSC_F(2,conditional_indx) = R1Off_On_PSC_F(2,conditional_indx) + R1Off_On_PSC_fF*(R1Off_On_PSC_maxF-R1Off_On_PSC_F(2,conditional_indx)); R1Off_On_PSC_P(2,conditional_indx) = R1Off_On_PSC_P(2,conditional_indx)*(1 - R1Off_On_PSC_fP); end
  ...
  R1On_Off_PSC_syn(n,:)=R1On_Off_PSC_gSYN.*(R1On_Off_PSC_s(2,:)*R1On_Off_PSC_netcon).*(R1On_V(2,:)-R1On_Off_PSC_ESYN);
  ...
  R1Off_On_PSC_syn(n,:)=R1Off_On_PSC_gSYN.*(R1Off_On_PSC_s(2,:)*R1Off_On_PSC_netcon).*(R1Off_V(2,:)-R1Off_On_PSC_ESYN);
...
R1On_Off_PSC_s(1,:)=R1On_Off_PSC_s(2,:);
R1On_Off_PSC_x(1,:)=R1On_Off_PSC_x(2,:);
R1On_Off_PSC_F(1,:)=R1On_Off_PSC_F(2,:);
R1On_Off_PSC_P(1,:)=R1On_Off_PSC_P(2,:);
R1On_Off_PSC_q(1,:)=R1On_Off_PSC_q(2,:);
...
R1Off_On_PSC_s(1,:)=R1Off_On_PSC_s(2,:);
R1Off_On_PSC_x(1,:)=R1Off_On_PSC_x(2,:);
R1Off_On_PSC_F(1,:)=R1Off_On_PSC_F(2,:);
R1Off_On_PSC_P(1,:)=R1Off_On_PSC_P(2,:);
R1Off_On_PSC_q(1,:)=R1Off_On_PSC_q(2,:);
