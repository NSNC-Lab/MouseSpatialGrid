...
for k=2:ntime
  ...
  R2Off_V_k1 = ( (R2Off_E_L-R2Off_V(n-1,:)) - R2Off_R*R2Off_g_ad(n-1,:).*(R2Off_V(n-1,:)-R2Off_E_k) - R2Off_R*((((R2Off_S2OnOff_PSC_gSYN.*(R2Off_S2OnOff_PSC_s(n-1,:)*R2Off_S2OnOff_PSC_netcon).*(R2Off_V(n-1,:)-R2Off_S2OnOff_PSC_ESYN))))) + R2Off_R*R2Off_Itonic.*R2Off_Imask + R2Off_R*R2Off_noise.*randn(1,R2Off_Npop) ) / R2Off_tau;
  R2Off_g_ad_k1 = -R2Off_g_ad(n-1,:) / R2Off_tau_ad;
  S2OnOff_V_k1 = ( (S2OnOff_E_L-S2OnOff_V(n-1,:)) - S2OnOff_R*S2OnOff_g_ad(n-1,:).*(S2OnOff_V(n-1,:)-S2OnOff_E_k) - S2OnOff_R*((((S2OnOff_R1On_PSC_gSYN.*(S2OnOff_R1On_PSC_s(n-1,:)*S2OnOff_R1On_PSC_netcon).*(S2OnOff_V(n-1,:)-S2OnOff_R1On_PSC_ESYN))))) + S2OnOff_R*S2OnOff_Itonic.*S2OnOff_Imask + S2OnOff_R*S2OnOff_noise.*randn(1,S2OnOff_Npop) ) / S2OnOff_tau;
