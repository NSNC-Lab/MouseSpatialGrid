...
R1On_On_PSC_s = zeros(nsamp,On_Npop);
R1On_On_PSC_s(1,:) =  zeros(1,On_Npop);
R1On_On_PSC_x = zeros(nsamp,On_Npop);
R1On_On_PSC_x(1,:) =  zeros(1,On_Npop);
R1On_On_PSC_F = zeros(nsamp,On_Npop);
R1On_On_PSC_F(1,:) =  ones(1,On_Npop);
R1On_On_PSC_P = zeros(nsamp,On_Npop);
R1On_On_PSC_P(1,:) =  ones(1,On_Npop);
R1On_On_PSC_q = zeros(nsamp,On_Npop);
