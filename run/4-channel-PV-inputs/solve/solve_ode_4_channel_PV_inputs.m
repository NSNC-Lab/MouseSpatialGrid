...
for k=2:ntime
  ...
  ROn_V_k1 = ( (p.ROn_E_L-ROn_V(n-1,:)) - ROn_R*ROn_g_ad(n-1,:).*(ROn_V(n-1,:)-p.ROn_E_k) - ROn_R*((((p.ROn_On_PSC_gSYN.*(ROn_On_PSC_s(n-1,:)*ROn_On_PSC_netcon).*(ROn_V(n-1,:)-p.ROn_On_PSC_ESYN))))+((((p.ROn_SOnOff_PSC_gSYN.*(ROn_SOnOff_PSC_s(n-1,:)*ROn_SOnOff_PSC_netcon).*(ROn_V(n-1,:)-p.ROn_SOnOff_PSC_ESYN))))+((((p.ROn_ROn_iNoise_V3_nSYN.*(ROn_ROn_iNoise_V3_sn(n-1,:)*ROn_ROn_iNoise_V3_netcon).*(ROn_V(n-1,:)-p.ROn_ROn_iNoise_V3_E_exc))))+((((((ROn_X_PSC3_s(n-1,:)*ROn_X_PSC3_netcon).*(ROn_V(n-1,:)-p.ROn_X_PSC3_ESYN))*p.ROn_X_PSC3_gSYN)))+((((p.ROn_TD_PSC_gSYN.*(ROn_TD_PSC_s(n-1,:)*ROn_TD_PSC_netcon).*(ROn_V(n-1,:)-p.ROn_TD_PSC_ESYN))))))))) + ROn_R*p.ROn_Itonic.*ROn_Imask + ROn_R*p.ROn_noise.*randn(1,p.ROn_Npop) ) / ROn_tau;
