function [T,On_V,On_g_ad,Off_V,Off_g_ad,ROn_V,ROn_g_ad,ROff_V,ROff_g_ad,SOnOff_V,SOnOff_g_ad,TD_V,TD_g_ad,X_V,X_g_ad,C_V,C_g_ad,ROn_On_PSC_s,ROn_On_PSC_x,ROn_On_PSC_F,ROn_On_PSC_P,ROn_On_PSC_q,SOnOff_On_PSC_s,SOnOff_On_PSC_x,SOnOff_On_PSC_F,SOnOff_On_PSC_P,SOnOff_On_PSC_q,ROn_SOnOff_PSC_s,ROn_SOnOff_PSC_x,ROn_SOnOff_PSC_F,ROn_SOnOff_PSC_P,ROn_SOnOff_PSC_q,ROff_SOnOff_PSC_s,ROff_SOnOff_PSC_x,ROff_SOnOff_PSC_F,ROff_SOnOff_PSC_P,ROff_SOnOff_PSC_q,ROff_Off_PSC_s,ROff_Off_PSC_x,ROff_Off_PSC_F,ROff_Off_PSC_P,ROff_Off_PSC_q,SOnOff_Off_PSC_s,SOnOff_Off_PSC_x,SOnOff_Off_PSC_F,SOnOff_Off_PSC_P,SOnOff_Off_PSC_q,ROn_ROn_iNoise_V3_sn,ROn_ROn_iNoise_V3_xn,X_ROn_PSC_s,X_ROn_PSC_x,X_ROn_PSC_F,X_ROn_PSC_P,X_ROn_PSC_q,ROn_X_PSC_s,ROn_X_PSC_x,ROn_X_PSC_F,ROn_X_PSC_P,ROn_X_PSC_q,ROn_TD_PSC_s,ROn_TD_PSC_x,ROn_TD_PSC_F,ROn_TD_PSC_P,ROn_TD_PSC_q,ROff_TD_PSC_s,ROff_TD_PSC_x,ROff_TD_PSC_F,ROff_TD_PSC_P,ROff_TD_PSC_q,X_TD_PSC_s,X_TD_PSC_x,X_TD_PSC_F,X_TD_PSC_P,X_TD_PSC_q,C_ROn_PSC_s,C_ROn_PSC_x,C_ROn_PSC_F,C_ROn_PSC_P,C_ROn_PSC_q,On_V_spikes,Off_V_spikes,ROn_V_spikes,ROff_V_spikes,SOnOff_V_spikes,TD_V_spikes,X_V_spikes,C_V_spikes,On_On_IC_iIC,Off_Off_IC_iIC,ROn_On_PSC_syn,SOnOff_On_PSC_syn,ROn_SOnOff_PSC_syn,ROff_SOnOff_PSC_syn,ROff_Off_PSC_syn,SOnOff_Off_PSC_syn,X_ROn_PSC_syn,ROn_X_PSC_syn,ROn_TD_PSC_syn,ROff_TD_PSC_syn,X_TD_PSC_syn,C_ROn_PSC_syn,On_R,On_tau,On_Imask,Off_R,Off_tau,Off_Imask,ROn_R,ROn_tau,ROn_Imask,ROff_R,ROff_tau,ROff_Imask,SOnOff_R,SOnOff_tau,SOnOff_Imask,TD_R,TD_tau,TD_Imask,TD_Icur,X_R,X_tau,X_Imask,C_R,C_tau,C_Imask,On_On_IC_netcon,On_On_IC_input,Off_Off_IC_netcon,Off_Off_IC_input,ROn_On_PSC_netcon,ROn_On_PSC_scale,SOnOff_On_PSC_netcon,SOnOff_On_PSC_scale,ROn_SOnOff_PSC_netcon,ROn_SOnOff_PSC_scale,ROff_SOnOff_PSC_netcon,ROff_SOnOff_PSC_scale,ROff_Off_PSC_netcon,ROff_Off_PSC_scale,SOnOff_Off_PSC_netcon,SOnOff_Off_PSC_scale,ROn_ROn_iNoise_V3_netcon,ROn_ROn_iNoise_V3_token,ROn_ROn_iNoise_V3_scale,X_ROn_PSC_netcon,X_ROn_PSC_scale,ROn_X_PSC_netcon,ROn_X_PSC_scale,ROn_TD_PSC_netcon,ROn_TD_PSC_scale,ROff_TD_PSC_netcon,ROff_TD_PSC_scale,X_TD_PSC_netcon,X_TD_PSC_scale,C_ROn_PSC_netcon,C_ROn_PSC_scale]=solve_ode
...
ROn_X_PSC_s = zeros(nsamp,p.X_Npop);
ROn_X_PSC_s(1,:) =  zeros(1,p.X_Npop);
ROn_X_PSC_x = zeros(nsamp,p.X_Npop);
ROn_X_PSC_x(1,:) =  zeros(1,p.X_Npop);
ROn_X_PSC_F = zeros(nsamp,p.X_Npop);
ROn_X_PSC_F(1,:) =  ones(1,p.X_Npop);
ROn_X_PSC_P = zeros(nsamp,p.X_Npop);
ROn_X_PSC_P(1,:) =  ones(1,p.X_Npop);
ROn_X_PSC_q = zeros(nsamp,p.X_Npop);
ROn_X_PSC_q(1,:) =  ones(1,p.X_Npop);
...
ROn_X_PSC_syn = zeros(nsamp,p.ROn_Npop);
ROn_X_PSC_syn(1,:)=p.ROn_X_PSC_gSYN.*(ROn_X_PSC_s(1,:)*ROn_X_PSC_netcon).*(ROn_V(1,:)-p.ROn_X_PSC_ESYN);
...
for k=2:ntime
  ...
  ROn_V_k1 = ( (p.ROn_E_L-ROn_V(n-1,:)) - ROn_R*ROn_g_ad(n-1,:).*(ROn_V(n-1,:)-p.ROn_E_k) - ROn_R*((((p.ROn_On_PSC_gSYN.*(ROn_On_PSC_s(n-1,:)*ROn_On_PSC_netcon).*(ROn_V(n-1,:)-p.ROn_On_PSC_ESYN))))+((((p.ROn_SOnOff_PSC_gSYN.*(ROn_SOnOff_PSC_s(n-1,:)*ROn_SOnOff_PSC_netcon).*(ROn_V(n-1,:)-p.ROn_SOnOff_PSC_ESYN))))+((((p.ROn_ROn_iNoise_V3_nSYN.*(ROn_ROn_iNoise_V3_sn(n-1,:)*ROn_ROn_iNoise_V3_netcon).*(ROn_V(n-1,:)-p.ROn_ROn_iNoise_V3_E_exc))))+((((p.ROn_X_PSC_gSYN.*(ROn_X_PSC_s(n-1,:)*ROn_X_PSC_netcon).*(ROn_V(n-1,:)-p.ROn_X_PSC_ESYN))))+((((p.ROn_TD_PSC_gSYN.*(ROn_TD_PSC_s(n-1,:)*ROn_TD_PSC_netcon).*(ROn_V(n-1,:)-p.ROn_TD_PSC_ESYN))))))))) + ROn_R*p.ROn_Itonic.*ROn_Imask + ROn_R*p.ROn_noise.*randn(1,p.ROn_Npop) ) / ROn_tau;
  ...
  X_ROn_PSC_q_k1 = 0;
  ROn_X_PSC_s_k1 = ( ROn_X_PSC_scale * ROn_X_PSC_x(n-1,:) - ROn_X_PSC_s(n-1,:) )/p.ROn_X_PSC_tauR;
  ROn_X_PSC_x_k1 = -ROn_X_PSC_x(n-1,:)/p.ROn_X_PSC_tauD;
  ROn_X_PSC_F_k1 = (1 - ROn_X_PSC_F(n-1,:))/p.ROn_X_PSC_tauF;
  ROn_X_PSC_P_k1 = (1 - ROn_X_PSC_P(n-1,:))/p.ROn_X_PSC_tauP;
  ROn_X_PSC_q_k1 = 0;
  ...
  SOnOff_On_PSC_P(n,:) = SOnOff_On_PSC_P(n-1,:)+dt*SOnOff_On_PSC_P_k1;
  SOnOff_On_PSC_q(n,:) = SOnOff_On_PSC_q(n-1,:)+dt*SOnOff_On_PSC_q_k1;
  ROn_SOnOff_PSC_s(n,:) = ROn_SOnOff_PSC_s(n-1,:)+dt*ROn_SOnOff_PSC_s_k1;
  ROn_SOnOff_PSC_x(n,:) = ROn_SOnOff_PSC_x(n-1,:)+dt*ROn_SOnOff_PSC_x_k1;
  ROn_SOnOff_PSC_F(n,:) = ROn_SOnOff_PSC_F(n-1,:)+dt*ROn_SOnOff_PSC_F_k1;
  ROn_SOnOff_PSC_P(n,:) = ROn_SOnOff_PSC_P(n-1,:)+dt*ROn_SOnOff_PSC_P_k1;
  ROn_SOnOff_PSC_q(n,:) = ROn_SOnOff_PSC_q(n-1,:)+dt*ROn_SOnOff_PSC_q_k1;
  ROff_SOnOff_PSC_s(n,:) = ROff_SOnOff_PSC_s(n-1,:)+dt*ROff_SOnOff_PSC_s_k1;
  ROff_SOnOff_PSC_x(n,:) = ROff_SOnOff_PSC_x(n-1,:)+dt*ROff_SOnOff_PSC_x_k1;
  ROff_SOnOff_PSC_F(n,:) = ROff_SOnOff_PSC_F(n-1,:)+dt*ROff_SOnOff_PSC_F_k1;
  ROff_SOnOff_PSC_P(n,:) = ROff_SOnOff_PSC_P(n-1,:)+dt*ROff_SOnOff_PSC_P_k1;
  ROff_SOnOff_PSC_q(n,:) = ROff_SOnOff_PSC_q(n-1,:)+dt*ROff_SOnOff_PSC_q_k1;
  ROff_Off_PSC_s(n,:) = ROff_Off_PSC_s(n-1,:)+dt*ROff_Off_PSC_s_k1;
  ROff_Off_PSC_x(n,:) = ROff_Off_PSC_x(n-1,:)+dt*ROff_Off_PSC_x_k1;
  ROff_Off_PSC_F(n,:) = ROff_Off_PSC_F(n-1,:)+dt*ROff_Off_PSC_F_k1;
  ROff_Off_PSC_P(n,:) = ROff_Off_PSC_P(n-1,:)+dt*ROff_Off_PSC_P_k1;
  ROff_Off_PSC_q(n,:) = ROff_Off_PSC_q(n-1,:)+dt*ROff_Off_PSC_q_k1;
  SOnOff_Off_PSC_s(n,:) = SOnOff_Off_PSC_s(n-1,:)+dt*SOnOff_Off_PSC_s_k1;
  SOnOff_Off_PSC_x(n,:) = SOnOff_Off_PSC_x(n-1,:)+dt*SOnOff_Off_PSC_x_k1;
  SOnOff_Off_PSC_F(n,:) = SOnOff_Off_PSC_F(n-1,:)+dt*SOnOff_Off_PSC_F_k1;
  SOnOff_Off_PSC_P(n,:) = SOnOff_Off_PSC_P(n-1,:)+dt*SOnOff_Off_PSC_P_k1;
  SOnOff_Off_PSC_q(n,:) = SOnOff_Off_PSC_q(n-1,:)+dt*SOnOff_Off_PSC_q_k1;
  ...
  X_ROn_PSC_s(n,:) = X_ROn_PSC_s(n-1,:)+dt*X_ROn_PSC_s_k1;
  X_ROn_PSC_x(n,:) = X_ROn_PSC_x(n-1,:)+dt*X_ROn_PSC_x_k1;
  X_ROn_PSC_F(n,:) = X_ROn_PSC_F(n-1,:)+dt*X_ROn_PSC_F_k1;
  X_ROn_PSC_P(n,:) = X_ROn_PSC_P(n-1,:)+dt*X_ROn_PSC_P_k1;
  X_ROn_PSC_q(n,:) = X_ROn_PSC_q(n-1,:)+dt*X_ROn_PSC_q_k1;
  ROn_X_PSC_s(n,:) = ROn_X_PSC_s(n-1,:)+dt*ROn_X_PSC_s_k1;
  ROn_X_PSC_x(n,:) = ROn_X_PSC_x(n-1,:)+dt*ROn_X_PSC_x_k1;
  ROn_X_PSC_F(n,:) = ROn_X_PSC_F(n-1,:)+dt*ROn_X_PSC_F_k1;
  ROn_X_PSC_P(n,:) = ROn_X_PSC_P(n-1,:)+dt*ROn_X_PSC_P_k1;
  ROn_X_PSC_q(n,:) = ROn_X_PSC_q(n-1,:)+dt*ROn_X_PSC_q_k1;
  ROn_TD_PSC_s(n,:) = ROn_TD_PSC_s(n-1,:)+dt*ROn_TD_PSC_s_k1;
  ROn_TD_PSC_x(n,:) = ROn_TD_PSC_x(n-1,:)+dt*ROn_TD_PSC_x_k1;
  ROn_TD_PSC_F(n,:) = ROn_TD_PSC_F(n-1,:)+dt*ROn_TD_PSC_F_k1;
  ROn_TD_PSC_P(n,:) = ROn_TD_PSC_P(n-1,:)+dt*ROn_TD_PSC_P_k1;
  ROn_TD_PSC_q(n,:) = ROn_TD_PSC_q(n-1,:)+dt*ROn_TD_PSC_q_k1;
  ROff_TD_PSC_s(n,:) = ROff_TD_PSC_s(n-1,:)+dt*ROff_TD_PSC_s_k1;
  ROff_TD_PSC_x(n,:) = ROff_TD_PSC_x(n-1,:)+dt*ROff_TD_PSC_x_k1;
  ROff_TD_PSC_F(n,:) = ROff_TD_PSC_F(n-1,:)+dt*ROff_TD_PSC_F_k1;
  ROff_TD_PSC_P(n,:) = ROff_TD_PSC_P(n-1,:)+dt*ROff_TD_PSC_P_k1;
  ROff_TD_PSC_q(n,:) = ROff_TD_PSC_q(n-1,:)+dt*ROff_TD_PSC_q_k1;
  X_TD_PSC_s(n,:) = X_TD_PSC_s(n-1,:)+dt*X_TD_PSC_s_k1;
  X_TD_PSC_x(n,:) = X_TD_PSC_x(n-1,:)+dt*X_TD_PSC_x_k1;
  ...
  conditional_test=any(any(t == X_tspike+p.ROn_X_PSC_delay,1));
  conditional_indx=(any(t == X_tspike+p.ROn_X_PSC_delay,1));
  if conditional_test, ROn_X_PSC_x(n,conditional_indx) = ROn_X_PSC_x(n,conditional_indx) + ROn_X_PSC_q(n,conditional_indx);ROn_X_PSC_q(n,conditional_indx) = ROn_X_PSC_F(n,conditional_indx).*ROn_X_PSC_P(n,conditional_indx);ROn_X_PSC_F(n,conditional_indx) = ROn_X_PSC_F(n,conditional_indx) + p.ROn_X_PSC_fF*(p.ROn_X_PSC_maxF-ROn_X_PSC_F(n,conditional_indx)); ROn_X_PSC_P(n,conditional_indx) = ROn_X_PSC_P(n,conditional_indx)*(1 - p.ROn_X_PSC_fP); end
  ...
  ROn_X_PSC_syn(n,:)=p.ROn_X_PSC_gSYN.*(ROn_X_PSC_s(n,:)*ROn_X_PSC_netcon).*(ROn_V(n,:)-p.ROn_X_PSC_ESYN);
